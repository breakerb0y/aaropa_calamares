% calamares(SECTION) | User Commands
%
% "October 29 2024"
...
**calamares** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**calamares** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **calamares** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**calamares** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    calamares. See **foo.conf**(5) for further details.
...
**calamares** provides some return codes, that can be used in scripts:
